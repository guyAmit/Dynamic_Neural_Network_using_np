...
if __name__ == '__main__':
    ...
    net.add_layer(units=40, activation=net_utills.tanh, l2_regulaizer=0.7, dropout=0.8)
    ...
    costs_train, succ_train, costs_val, succ_val = \
        net.fit(X_train=X_train, C_train=Y_train, X_val=X_val, C_val=Y_val, epoch=35, batch_size=64, p=True)
    ...
    plt.savefig('task7/{}_net_succ.png'.format(data_path))
    plt.show()
    ...
    plt.savefig('task7/{}_net_cost.png'.format(data_path))
    plt.show()
